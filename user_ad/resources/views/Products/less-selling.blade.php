...
<head>
    ...
    <title>Less Selling | Ashar Alo Shop</title>
...
<meta http-equiv="refresh" content="600; url=https://adminasharalo.trodev.com/products/less-selling/{{$id->id}}">
    <!-- Favicon -->
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Products/</span> Less Selling</h4>
                    ...
                    <div class="row">
                        ...
                        <!-- Basic with Icons -->
                        <div class="card">
                            <h5 class="card-header">Less Selling</h5>
