...
<head>
    ...
    <title>Most Selling | Ashar Alo Shop</title>
...
<script>
  ...
  gtag('config', 'G-FRZFYEXM5Z');
    ...
    <meta http-equiv="refresh" content="600; url=https://adminasharalo.trodev.com/products/most-selling/{{$id->id}}">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Products/</span> Most Selling</h4>
                    ...
                    <div class="row">
                        ...
                        <!-- Basic with Icons -->
                        <div class="card">
                            <h5 class="card-header">Most Selling</h5>
                            <div class="table-responsive text-nowrap">
                                <table class="table table-hover">
                                    ...
                                    @foreach($carts as $cart)
                                        @if($cart->total_sold >= 10)
                                    <tr>
                                        <td><strong>{{$cart->product_id}}</strong></td>
                                        <td>{{$cart->product_name}}</td>

                                        <td>{{$cart->total_sold}}</td>
