...
<head>
    ...
    <title>Users List | Ashar Alo Shop</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Orders/</span> Users</h4>
                    ...
                    <div class="row">
                        ...
                        <!-- Basic with Icons -->
                        <div class="card">
                            <h5 class="card-header">Total Users: {{$count}}</h5>
                            <div class="table-responsive text-nowrap">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <td><strong>{{$users->fname}} {{$users->lname}}</strong></td>
                                        <td>{{$users->email}}</td>
                                        <td>{{$users->phone}}</td>
                                        <td>{{$users->shipaddress}}</td>
                                        <td>{{$users->city}}</td>
                                    </tr>
                                    @endforeach
                                    </tbody>
