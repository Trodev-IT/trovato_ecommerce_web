...
<head>
    ...
    <title>Delivered Orders | Ashar Alo Shop</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Orders/</span> Delivered Orders</h4>
                    ...
                    <div class="row">
                        ...
                        <!-- Basic with Icons -->
                        <div class="card">
                            <h5 class="card-header">Total Delivered Orders</h5>
                            <div class="table-responsive text-nowrap">
                                <table class="table table-hover">
                                    ...
                                    @foreach($delivered as $delivary)
                                    <tr>
                                        <td><strong>{{$delivary->product_id}}</strong></td>
                                        <td>{{$delivary->product_name}}</td>
                                        <td>
                                            {{$delivary->quantity}}
                                        </td>
                                        <td>{{$delivary->shipping_address}}</td>
                                        <td>
                                            {{$delivary->delivery_date}}
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
