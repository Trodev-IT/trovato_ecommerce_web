                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach($sub as $subcategory)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="sub-category" value="{{$subcategory->sub_category}}">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{route('deleteSubCategory',['id'=>$subcategory->id])}}" class="btn btn-primary">Delete</a>
                                            </td>
                                        </tr>
                                        </form>
                                    @endforeach
