...
<head>
    ...
    <title>Sub Category | TroVato HUB</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="{{route('sub-category',['id'=>$id->id])}}" class="menu-link" target="_blank">
                                <div data-i18n="Basic">Insert</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{route('subcategoryUpdate',['id'=>$id->id])}}" class="menu-link" target="_blank">
                ...
                <!-- Forms & Tables -->
                <li class="menu-header small text-uppercase"><span class="menu-header-text">Discount</span></li>
                <!-- Forms -->
                <li class="menu-item active">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon tf-icons bx bx-detail"></i>
                        <div data-i18n="Form Elements">Give Dicount</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="{{route('allcategory',['id'=>$id->id])}}" class="menu-link">
                                <div data-i18n="Basic Inputs">To All Categories</div>
                            </a>
                        </li>
                        <li class="menu-item active">
                            <a href="{{route('allsubcategory',['id'=>$id->id])}}" class="menu-link">
                                <div data-i18n="Input groups">To All Sub-Categories</div>
                            </a>
                        </li>
                    </ul>
                </li>
