...
<head>
    ...
    <title>Login | Ashar Alo Shop</title>

    <meta name="description" content="" />

    <link rel="canonical" href="https://www.adminasharalo.trodev.com/">
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2">Welcome to Ashar Alo Shop! 👋</h4>
                    <p class="mb-4">Please sign-in to your account and start the adventure</p>

                    <form id="formAuthentication" class="mb-3" action="{{route('logged')}}" method="POST">
                        @csrf
                        <div class="mb-3">
